<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="商品是否上架，0：下架，1：上架" prop="putWayFlag">
        <el-input
          v-model="queryParams.putWayFlag"
          placeholder="请输入商品是否上架，0：下架，1：上架"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="goodsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="商品是否上架，0：下架，1：上架" align="center" prop="putWayFlag" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="商品是否上架，0：下架，1：上架" prop="putWayFlag">
          <el-input v-model="form.putWayFlag" placeholder="请输入商品是否上架，0：下架，1：上架" />
        </el-form-item>
      </el-form>
