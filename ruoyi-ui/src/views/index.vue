...
<!--      <div style="position: relative;left: 600px">-->
<!--        <el-icon size="30"><VideoCameraFilled /></el-icon>      <span style="position: relative;top: -8px">-->
...
<!--<template><el-amap  :zoom="zoom" :center="center">-->
<!--</el-amap></template>-->
<!--<script>-->
<!--// 引入vue-amap-->
...
<!--  // 高德的key-->
<!--  key: '6b35d31f0369f9d8bf310ea9f80c96e3',-->
<!--});-->
